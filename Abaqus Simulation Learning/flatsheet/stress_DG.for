...
C      END DO
	  ...
	  open(105,file='C:\Users\khanfari\Box\Asymmetric Tensor_Fariba\Abaqus Examples\flatsheet\job umat\flatsheet_dg.txt',position='append')
	  WRITE(105,*)DFGRD1
	  close(105)
...
C	  close(105)
	  ...
	  open(105,file='C:\Users\khanfari\Box\Asymmetric Tensor_Fariba\Abaqus Examples\flatsheet\job umat\flatsheet_stress.txt',position='append')
	  WRITE(105,*)STRESS
	  close(105)
